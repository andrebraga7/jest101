...
describe("game object contains corrects keys", () => {
    ...
    test("turnInProgress key to be true", () => {
        expect("turnInProgress" in game).toBe(true);
    });
});
...
describe("newGame works correctly", () => {
    beforeAll(() => {
        game.score = 42;
        game.playerMoves = ["button1", "button2", "button1"];
        game.currentGame = ["button1", "button2", "button1"];
    ...
    test("should display zero for the element with an id of score", () => {
